...
class UserCreate(SignupForm):
    ...
    role = forms.ChoiceField(choices=(('is_employee', 'Employee'),
                                      ('is_admin', 'Admin')), required=True, widget=forms.RadioSelect,)
...
class ClientForm(forms.ModelForm):
    ...
    class Meta:
        model = Clients
        fields = ('clients_id', 'phone_number',
                  'company_name', 'address', 'gender')
...
class AssetForm(forms.ModelForm):
    class Meta:
        model = Assets
        fields = ['assigned_to', 'asset_name', 'asset_id', 'description',
                  'purchase_date', 'receipt', 'assigned_date',  'warranty_end', 'asset_amount']
        widgets = {
